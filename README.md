# intelligent-transport-system-dsa
A C++ based Data Structures &amp; Algorithms project that simulates an intelligent transport network management system, using graph-based models to manage routes, traffic flow, and optimized decision-making.
